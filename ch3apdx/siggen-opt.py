...
# Title: Siggen2
# Generated: Sun Sep 16 10:33:05 2018
##################################################
...
def main(top_block_cls=siggen, options=None):
    ...
    tb = top_block_cls()
    if options and options.freq:
        tb.set_freq(options.freq)
    tb.start()
    tb.wait()

if __name__ == '__main__':
    parser = OptionParser('usage: %prog [options]')
    parser.add_option('-f', '--freq', action='store', type='float', dest='freq', help='set frequency')
